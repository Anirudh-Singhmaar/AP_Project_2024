...
public class WinningScreen implements Screen {
    ...
    public WinningScreen(Game game) {
        ...
        Image winImage = new Image(new Texture("win.png")); // Add this image to your assets
        ...
        TextureRegionDrawable upDrawable = new TextureRegionDrawable(new TextureRegion(new Texture("button_up.png")));
        TextureRegionDrawable downDrawable = new TextureRegionDrawable(new TextureRegion(new Texture("button_down.png")));
